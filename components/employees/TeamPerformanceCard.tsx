        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-50">
            <div className="flex items-center justify-between mb-6">
                ...
                <button className="flex items-center gap-1 px-2 py-1 rounded-lg hover:bg-slate-50 text-slate-500 transition-colors">
                    <span className="text-[12px] font-bold uppercase tracking-widest">Late Arrival</span>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[12px] font-semibold text-slate-500 uppercase tracking-tight">{member.role.split(' ')[0]}</p>
                            </div>
                        </div>
