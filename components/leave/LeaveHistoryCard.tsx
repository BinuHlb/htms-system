                        ...
                        >
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h4 className="text-base font-black text-slate-900 truncate tracking-tight">{item.type}</h4>
                                    <p className="text-xs text-slate-500 font-bold mt-1 tracking-tight">
                                        ...
                                        <span className="ml-2 text-primary font-black">({item.days} Days)</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            {item.status === 'Approved' && (
                                <div className="mt-6 pt-6 border-t border-slate-50 flex items-center justify-between animate-in slide-in-from-top-2">
                                    <div className="flex -space-x-2">
                                        ...
                                        <div className="size-7 rounded-full border-2 border-white bg-slate-100 flex items-center justify-center text-[8px] font-black text-slate-400 shadow-sm">+2</div>
                                    </div>
                                    <button
                                        onClick={() => onRejoin?.(item.id)}
                                        className="px-5 py-2.5 bg-primary text-white text-[10px] font-black uppercase tracking-widest rounded-xl shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center gap-2"
                                    >
